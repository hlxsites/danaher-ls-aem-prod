...
// include pro paths
export const includeProdPaths = ['e-buy', 'products/', 'brands', 'products.html', 'blog', 'news', 'videos', 'library', 'expert-eds', 'new-lab', 'application', 'solutions/analytical', 'solutions/digital/products', 'about-us', 'resources'];
