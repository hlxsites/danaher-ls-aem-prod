...
export const orderItems = (response) => {
  ...
  const unitPriceDiv = (cartItemValue) => {
    ...
    const qtyValue = cartItemValue.quantity.value;
    const listPrc = cartItemValue.productData.listPrice.value;
    const salePrc = cartItemValue.productData.salePrice.value;
    const listPriceValue = qtyValue * listPrc;
    const salesPriceValue = qtyValue * salePrc;
  ...
  const cartItemDiv = (cartItemValue) => {
    const productSKU = cartItemValue.productData.sku;
