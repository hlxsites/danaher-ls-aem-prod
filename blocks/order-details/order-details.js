...
export default async function decorate(block) {
  ...
  const orderDetailsContainer = div({
    class: 'w-full inline-flex md:flex-row flex-col gap-5 md:pb-0 pb-[7px]',
  });
  const orderDetail = div({
    class: 'md:w-[70%] w-[100%] p-6 bg-white border-t border-l border-r border-b border-gray-300 inline-flex flex-col justify-start items-center gap-6',
  });
