...
export default async function decorate(block) {
  ...
  const fullTabConfig = {
    ...
    specifications: { label: 'Specifications', available: !!response?.raw?.attributejson?.trim() || ('specifications' in authoredTabMap) },
    ...
    parts: { label: 'Product Parts List', available: !!response?.raw?.bundlepreviewjson?.trim() || ('parts' in authoredTabMap) },
