...
export default async function decorate(block) {
  ...
  if (orderId) {
    ...
    const orderDescription = div(
      {
        class: 'self-stretch flex justify-start items-start gap-6',
      },
      div(
        {
        ...
        span(
          {
            id: 'notificationIcon',
            class: 'icon w-20 h-20 fill-current icon-light-circle [&_svg>use]:stroke-emerald-400',
          },
        ),
      ),
      div(
        ...
        div(
          {
            class: 'justify-start text-4xl text-black font-normal leading-[48px]',
          },
          'Order Submitted',
        ),
        div(
          {
            class:
            'self-stretch justify-start text-gray-900 text-3xl leading-10',
          },
    ...
    decorateIcons(orderDescription);
    ...
    orderConfirmationWrapper.append(descriptionDiv);
