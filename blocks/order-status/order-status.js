...
const noContentDiv = a(
  ...
  div(
    {
      class:
        'w-[186.4px] h-[46px] p-3 self-stretch inline-flex flex-col justify-start items-start',
    },
    div(
      {
        class:
...
export default async function decorate(block) {
  ...
  const orderTable = table(
    {
      class:
        'w-full border border-gray-200 h-[500px] inline-flex flex-col justify-start items-start max-h-[642px] pr-[10px] overflow-x-auto overflow-y-auto gap-6 pt-0 [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500',
      id: 'orderTable',
    },
    tr(
      {
