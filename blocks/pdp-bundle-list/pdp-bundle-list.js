...
export default async function decorate(block) {
  ...
  // }
  block.prepend(div({ class: 'text-2xl text-black leading-8 font-medium py-6 ', style: 'font-weight: 400 !important;' }, 'Product Parts List'));
  applyResponsivePadding(block, '8px');
