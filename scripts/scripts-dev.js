...
if (window.location.host === 'lifesciences.danaher.com' || useProd === 'true') {
  window.DanaherConfig = {
    ...
    auth0Domain: 'login.lifesciences.danaher.com',
  ...
  window.DanaherConfig = {
    ...
    auth0Domain: 'stage.login.lifesciences.danaher.com',
...
// confirm for checkout related pages / functions / library
window.EbuyConfig = {
  cartPageUrl: '/us/en/e-buy/cart.html',
  dashboardPage: {
    url: '/us/en/e-buy/dashboard.html',
    label: 'Dashboard',
  },
  addressPageUrl: '/us/en/e-buy/addresses.html',
  myAddressPageUrl: '/us/en/e-buy/myaddresses.html',
  shippingPageUrl: '/us/en/e-buy/shipping.html',
  googleMapsApi: 'https://maps.googleapis.com/maps/api/js?key=AIzaSyCCLCWBAwQawztgIw0AobQk8q-2OlEzuzQ&libraries=places',
  paymentPageUrl: '/us/en/e-buy/payment.html',
  loginPageUrl: '/us/en/e-buy/login.html',
  registerPageUrl: '/us/en/e-buy/register.html',
  orderStatusPageUrl: '/us/en/e-buy/orderstatus.html',
  orderSubmitPageUrl: '/us/en/e-buy/ordersubmit.html',
  orderDetailsPageUrl: '/us/en/e-buy/orderdetails.html',
  paymentMethodsPageUrl: '/us/en/e-buy/paymentmethods.html',
  myProfilePageUrl: '/us/en/e-buy/myprofile.html',
  requestedQuoteDetailsPageUrl: '/us/en/e-buy/requestquotedetails.html',
  requestedQuotesPageUrl: '/us/en/e-buy/requestedquotes.html',
  termsConditions: {
    text: 'I agree to the',
    urlText: 'Terms and Conditions',
    url: '#',
  },
  stripeLibrary: 'https://js.stripe.com/v3/',
  paymentLoadingText: 'Your payment is being processed. Please do not refresh the page.',
  stripeKey: 'pk_test_51S5QfsDjNZoJyC3KgIgbXK2uTa4QiwEq3O1d07WoaWZTkpp2bXZpr9RGwBHYYn15GR2hVBIupbeoK4kuk2A8dkZ200qdZQhfsl',
};
